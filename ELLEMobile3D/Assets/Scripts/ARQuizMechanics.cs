...
public class ARQuizMechanics : MonoBehaviour 
{
    ...
    private void WordComparison()
    {
        ...
        if (selectedWord == languagePack.Cards[indexes[correctIndex]].destTerm)
        {
            UpdateIndexes();
            GenerateWordDisplay();
        ...
        else if (selectedWord.Length > 0 && selectedWord != languagePack.Cards[indexes[correctIndex]].destTerm)
        {			
            if (!mutex)
    ...
    public void GenerateWordDisplay()
    {
        ...
        wordOne.GetComponent<TextMesh>().text = languagePack.Cards[indexes[0]].destTerm;
        wordTwo.GetComponent<TextMesh>().text = languagePack.Cards[indexes[1]].destTerm;
        wordThree.GetComponent<TextMesh>().text = languagePack.Cards[indexes[2]].destTerm;
        ...
        wordToFind.text = languagePack.Cards[indexes[correctWord]].sourceTerm;
    }
}
